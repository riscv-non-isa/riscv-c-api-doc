...
Note: riscv_cbo_prefetch is a wrapper around builtin_prefetch. 
Similar to Prefetch Intrinsics, the following table presents the mapping from 
the riscv_cbo_prefetch function to the corresponding assembly instructions, 
...
|`+__riscv_cbo_prefetch(ptr, 0, 0 /* locality */);+` |`ntl.all + prefetch.r (ptr)`
|`+__riscv_cbo_prefetch(ptr, 0, 1 /* locality */);+` |`ntl.pall + prefetch.r (ptr)`
|`+__riscv_cbo_prefetch(ptr, 0, 2 /* locality */);+` |`ntl.p1 + prefetch.r (ptr)`
|`+__riscv_cbo_prefetch(ptr, 0, 3 /* locality */);+` |`prefetch.r (ptr)`
|`+__riscv_cbo_prefetch(ptr, 1, 0 /* locality */);+` |`ntl.all + prefetch.w (ptr)`
|`+__riscv_cbo_prefetch(ptr, 1, 1 /* locality */);+` |`ntl.pall + prefetch.w (ptr)`
|`+__riscv_cbo_prefetch(ptr, 1, 2 /* locality */);+` |`ntl.p1 + prefetch.w (ptr)`
|`+__riscv_cbo_prefetch(ptr, 1, 3 /* locality */);+` |`prefetch.w (ptr)`
|===
