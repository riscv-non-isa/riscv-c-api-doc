...
```shell
git clone --recurse-submodules https://github.com/riscv-non-isa/riscv-c-api-doc.git
```

All in one single line:

```shell
git clone --recurse-submodules  https://github.com/riscv-non-isa/riscv-c-api-doc.git && cd riscv-c-api-doc && git submodule update --init --recursive
